...
const unsigned char bdqBase::kPacketMagicNum = 0xef;
const unsigned char bdqBase::kPacketFlagSync = 0x01;
...
const unsigned char  bdqBase::kSyncHeader[2] =
  {bdqBase::kPacketMagicNum, 0};
